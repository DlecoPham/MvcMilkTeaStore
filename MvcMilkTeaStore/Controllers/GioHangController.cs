...
namespace MvcMilkTeaStore.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult ThemSanPhamVaoGio(int MaSP)
        {
            ...
            MatHangMua sanPham = gioHang.FirstOrDefault(s => s.MaTraSua == MaSP);
            ...
            return RedirectToAction("Details", "MilkTeaStore", new { id = MaSP });
        }
        ...
        public ActionResult XoaMatHang(int MaSP)
        {
            ...
            var sanpham = gioHang.FirstOrDefault(s => s.MaTraSua == MaSP);
            if (sanpham != null)
            {
                gioHang.RemoveAll(s => s.MaTraSua == MaSP);
        ...
        public ActionResult DongYDatHang()
        {
            ...
            foreach (var sanpham in gioHang)
            {
                ...
                chitiet.Matrasua = sanpham.MaTraSua;
